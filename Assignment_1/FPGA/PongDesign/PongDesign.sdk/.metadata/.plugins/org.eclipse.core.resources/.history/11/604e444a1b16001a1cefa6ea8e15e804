...
void drawPixel(int X, int Y, gameData* game)
{
	...
	switch (selectColour)
	{
		case 'r' : game->colourArray[Y][X].red = COLOUR_INTENSITY;
				   break;
		case 'g' : game->colourArray[Y][X].green = COLOUR_INTENSITY;
				   break;
		case 'b' : game->colourArray[Y][X].blue = COLOUR_INTENSITY;
				   break;
		default  : game->colourArray[Y][X].red = COLOUR_INTENSITY;
			       game->colourArray[Y][X].green = COLOUR_INTENSITY;
				   game->colourArray[Y][X].blue = COLOUR_INTENSITY;
				   break;
	}
}
